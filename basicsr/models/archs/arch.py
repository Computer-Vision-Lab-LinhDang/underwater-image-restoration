...
class DenseLayer(nn.Module):
    def __init__(self, nChannels, growthRate, kernel_size=3):
        ...
        self.conv = nn.Sequential(
            nn.Conv2d(nChannels, nChannels, kernel_size=kernel_size, 
                      stride=1, padding=(kernel_size - 1) // 2, groups=nChannels),
            nn.Conv2d(nChannels, growthRate, kernel_size=1,
...
class LowFrequencyBlock(nn.Module):
    def __init__(self,
        ...
        # denseLayers_3 += [nn.Conv2d(channels_3, channels, 1),
        #                   nn.Sigmoid()]
...
class Block(nn.Module):
    def __init__(self, 
        ...
        self.dwtblock = LowFrequencyBlock(channels)
