...
def measure_UIQMs(dir_name, im_res=(256, 256)):
    ...
    for img_path in paths:
        ...
        im = Image.open(img_path).convert("RGB").resize(im_res)
...
gen_dir = "/home/aidev/workspace/underwater/underwater/demo/non-ref/EUVP/UnderWater" 
gen_uqims = measure_UIQMs(gen_dir)
print ("Enhanced EUVP UIQMs >> Mean: {0} std: {1}".format(np.mean(gen_uqims), np.std(gen_uqims)))

gen_dir = "/home/aidev/workspace/underwater/underwater/demo/non-ref/RUIE/UnderWater" 
gen_uqims = measure_UIQMs(gen_dir)
print ("Enhanced RUIE UIQMs >> Mean: {0} std: {1}".format(np.mean(gen_uqims), np.std(gen_uqims)))

gen_dir = "/home/aidev/workspace/underwater/underwater/demo/non-ref/UIEB/UnderWater" 
gen_uqims = measure_UIQMs(gen_dir)
print ("Enhanced UIEB UIQMs >> Mean: {0} std: {1}".format(np.mean(gen_uqims), np.std(gen_uqims)))
